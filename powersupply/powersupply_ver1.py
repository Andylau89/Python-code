...
# row 3
    ...
    # set_chan1_off = tk.Button(channel_1, text='Output Off', width=10, command=read_data).grid(column=2, row=4)
###########################################
...
btn_login = tk.Button(option2, text='read', width=8, bg='yellow', command=get_voltage_current)
